...
public class MainActivity extends BasePermissionAppCompatActivity {
    ...
    private BottomSheetDialogView getBottomSheetDialogView() {
        ...
        bottomSheetDialog.setDescription("""
                ...
                You can view all changes whenever you want at the About Sketchware Next screen.""");
    ...
    private void allFilesAccessCheck() {
        if (Build.VERSION.SDK_INT > 29) {
            ...
            if (!optOutFile.exists() && !granted) {
                ...
                dialog.setMessage("Starting with Android 11, Sketchware Next needs a new permission to avoid " + "taking ages to build projects. Don't worry, we can't do more to storage than " + "with current granted permissions.");
